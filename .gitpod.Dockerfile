...
RUN sudo touch /etc/apt/sources.list.d/debian.list && \
    echo "deb http://deb.debian.org/debian bullseye main" | sudo tee -a /etc/apt/sources.list.d/debian.list && \
    echo "deb http://deb.debian.org/debian bullseye-updates main" | sudo tee -a /etc/apt/sources.list.d/debian.list && \
    echo "deb http://deb.debian.org/debian-security bullseye/updates main" | sudo tee -a /etc/apt/sources.list.d/debian.list && \
